  ...
  try {
   const transporter= nodemailer.createTransport({
    ...
    const mailOptions={
      ...
      html:'<p>Hii '+name+',Please click here to <a href="http://127.0.0.1:5000/verify?id='+user_id+'">Click Here</a>your mail</p>'
    }
    transporter.sendMail(mailOptions,function (error,info) {
      if(error){
        ...
        console.log('Email has beensent:-',info.response)
      }
    })
  } catch (error) {
  ...
  try {
   const transporter= nodemailer.createTransport({
    ...
    const mailOptions={
      ...
      html:'<p>Hii '+name+',Please click here to <a href="http://127.0.0.1:5000/forget-password?token='+token+'">Click Here</a>to reset password</p>'
    }
    transporter.sendMail(mailOptions,function (error,info) {
      if(error){
        console.log(error);
...
module.exports = {
    loadRegister,
    loadLogin,insertUser,upload,verifyMail,verifylogin,loadOtp,verifyOTP,loadHome,logOut,loadForget,frogetVerified,forgetPasswordload,resetPassword
};